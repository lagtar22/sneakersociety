<section class="container mt-5 mb-5">
    <div class="col-10 col-xs-12 col-sm-12 mx-auto mt-3 mb-5">
        ...
        <div class="container-fluid">
            <table class="table table-bordered rounded lg-4">
                <thead class="table-dark">
                    <tr class="marron h4 text-center">
                        <th>Categoria</th>
                        <th>Descripción</th>
                        <th>Operaciones</th>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="h5 text-center"> <?=$cate['ct_Nombre'];?> </td>
                        <td class="h5 text-center"> <?=$cate['ct_Descripcion'];?></td>
                        <td>
                            <div class="d-flex justify-content-evenly">
                                <a class="btn btn-primary" type="button" href="<?=base_url('administrador/categorias/darAltaCategoria/'. $cate['id'])?>">
        ...
        <hr class="mb-4">
        <div>
            <a class="btn btn-dark" type="button" href="<?=base_url(route_to("categorias"))?>">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-12 texto mt-6 mb-6">
            <p class="text-center h3 mb-3">
                No se encuentran categorias eliminadas
            </p>
