<!-- Mensaje al realizar una accion sobre la categoría -->
<?php
...
<section class="container mt-5 mb-5">
    <div class="col-10 col-xs-12 col-sm-12 mx-auto mt-3 mb-5">
        <h3 class="text-center beige fw-bold englobar">
            <svg width="28" height="28" fill="currentColor" class="bi bi-bookmarks" viewBox="0 0 18 18">
        ...
        <div class="ms-3">
            <p>
                <a class="btn btn-dark" type="button" href="<?=base_url(route_to('categorias_añadir'))?>">
                ...
                <a class="btn marron" type="button" href="<?=base_url(route_to('categorias_eliminados'))?>">
        ...
        <div class="container-fluid">
            <table class="table table-bordered rounded lg-4">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="h5 text-center"> <?=$fila['ct_Nombre'];?> </td>
                        <td class="h5 text-center"> <?=$fila['ct_Descripcion'];?></td>
                        <td class="h5 text-center">
                            <div class="d-flex justify-content-evenly">
                                <a class="btn btn-dark " type="button" href="<?=base_url('administrador/categorias/editarCategoria/'. $fila["id"])?>">
                                ...
                                <a href="#" class="btn btn-danger h3" onclick="confirmarBorrado('<?=base_url('administrador/categorias/borrarCategoria/'. $fila["id"])?>')">
