                    ...
                    <tr>
                        ...
                        <td class="h5 text-center">
                            <div class="d-flex justify-content-evenly">
                                <a class="btn btn-dark " type="button" href="<?=base_url('administrador/categorias/editarCategoria/'. $cate["id"])?>">
                                ...
                                <a class="btn btn-danger" href="<?=base_url('administrador/categorias/borrarCategoria/'. $cate["id"])?>" type="button">
