            ...
            <div class="col-12 col-lg-9 col-xl-7">
                <div class="card bg-marron beige shadow-2-strong card-registration" style="border-radius: 15px;">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form method="POST" action="<?php echo base_url(route_to('categorias_actualizar')) ?>">
                            <!-- Id de la categoria -->
                            ...
                            <div class="row">
                                <div class="form-outline h2">
                                    ...
                                    <input type="text" class="form-control form-control-lg" value="<?=$categoria['ct_Nombre']?>" name="ct_Nombre" id="ct_Nombre" placeholder="Ingrese nombre de la Categoria">
                            ...
                            <div class="row">
                                <div class="form-outline h2">
                                    ...
                                    <input type="text" class="form-control form-control-lg" value="<?=$categoria['ct_Descripcion']?>" name="ct_Descripcion" id="ct_Descripcion" placeholder="Ingrese descripción de la categoria">
