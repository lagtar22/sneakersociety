...
<section class="container mb-5 mt-5">
    <div class="col-10 col-xs-12 col-sm-12 mx-auto mt-3 mb-5">
        <h3 class="text-center fw-bold englobar beige">
            <svg width="28" height="28" fill="currentColor" class="bi bi-star" viewBox="0 0 18 18">
        ...
        <div class="ms-3">
            <p>
                <a class="btn btn-dark" type="button" href="<?=base_url(route_to('Marca_añadir'))?>">
                ...
                <a class="btn marron" type="button" href="<?=base_url(route_to('marcas_eliminadas'))?>">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-evenly">
                                <a class="btn btn-dark " type="button" href="<?=base_url('administrador/marca/editarMarca/'.$fila['marca_id'])?>">
                                ...
                                <a href="#" class="btn btn-danger h3" onclick="confirmarBorrado('<?=base_url('administrador/marca/borrarMarca/'. $fila["marca_id"])?>')">
...
<script>
    function confirmarBorrado(url) {
        Swal.fire({
            title: '¿Estás seguro que deseas eliminar esta marca?',
            icon: 'warning',
