                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-evenly">
                                <a class="btn btn-dark " type="button" href="<?=base_url('administrador/marca/editarMarca/'.$esp['marca_id'])?>">
                                ...
                                <a  class="btn btn-danger" href="<?=base_url('administrador/marca/borrarMarca/'. $esp['marca_id'])?>" type="button">
