            ...
            <div class="col-12 col-lg-9 col-xl-7">
                <div class="card bg-marron beige shadow-2-strong card-registration" style="border-radius: 15px;">
                    <div class="card-body p-4 p-md-5">
                        ...
                        <form method="POST" action="<?php echo base_url(route_to('marca_actualizar')) ?>">
                            <!-- ID de Marca -->
                            <input type="hidden" id="marca_id" name="marca_id" value="<?=$marca['marca_id']?>">
                            <div class="row">
                                <div class="form-outline h3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" value="<?=$marca['marca_nombre']?>" name="marca_nombre" id="marca_nombre" placeholder="Ingrese nombre de Marca">
