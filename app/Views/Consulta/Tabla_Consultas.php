...
<?php
    ...
    if(session()->getFlashdata('alertaExitosa')){
        ...
        "<p class='alert text-center alert-success mt-4 col-lg-8 col-md-8 col-sm-8 mx-auto w-50 h4' role='alert'>
            <svg class='icon icon-tabler icon-tabler-circle-check' width='28' height='28' viewBox='0 0 24 24' stroke-width='2' stroke='#5cb85c' fill='none' stroke-linecap='round' stroke-linejoin='round'>
...
<section class="container">
    <div class="col-12 col-xs-12 col-sm-12 mx-auto mt-6 mb-6">
        ...
        <div class="accordion w-75 mx-auto" id="accordion">
            <?php foreach($consultas as $consul):?>
                ...
                <h2 class="accordion-header" id="flush-headingOne">
                    <button class="accordion-button collapsed bg-primary text-light" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne<?php echo $i?>" aria-expanded="false" aria-controls="flush-collapseOne">
                        ...
                        <span class="fw-bold h3 ms-5">
                            Asunto: <?=$consul['con_Asunto'];?>
                        </span>
                        <span class="me-5 ms-5 fw-bold h3">
                            Fecha: <?=$consul['fecha_creacion'];?>
                        </span>
                    </button>
                </h2>
                <div id="flush-collapseOne<?php echo $i?>" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <p class="h4">
                            ...
                            <?=" ".$consul['con_Nombre']." ".$consul['con_Apellido'];?>
                        </p>
                        <p class="h4">
                            <span class="fw-bold">
                                Correo Electrónico:
                        ...
                        <div class="d-flex justify-content-evenly">
                            <a class="btn btn-dark" href="<?=base_url('administrador/consultaVerificada/'. $consul["id_Consulta"])?>" type="button">
        ...
        <?php else: ?>
        <div class="col-lg-12 col-md-12 col-sm-12 col-12 mt-6 mb-6">
            <p class="text-center h3 mb-3 ">
                No se encuentran consultas para leer
            </p>
        </div>
        <?php endif;?>
        <hr>
...
<section class="container">
    <div class="col-12 col-xs-12 col-sm-12 mx-auto mt-6 mb-6">
        <h5 class="text-center fw-bold englobar ">
        ...
        <hr class="mb-4 ">
        <?php if(isset($consultas_Leidas)): ?>
        <div class="accordion w-75 mx-auto" id="accordion">
            <?php foreach($consultas_Leidas as $consultas):
                $i++;
            ?>
            <div class="accordion-item mb-3">
                <h2 class="accordion-header" id="flush-headingOne">
                    <button class="accordion-button collapsed bg-primary text-light" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne<?php echo $i?>" aria-expanded="false" aria-controls="flush-collapseOne">
                        ...
                        <span class="fw-bold h3 ms-5">
                            Asunto: <?=$consultas['con_Asunto'];?>
                        </span>
                        <span class="me-5 ms-5 fw-bold h3">
                            Fecha: <?=$consultas['fecha_creacion'];?>
                        </span>
                    </button>
                </h2>
                <div id="flush-collapseOne<?php echo $i?>" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <p class="h4">
                            ...
                            <?=" ".$consultas['con_Nombre']." ".$consultas['con_Apellido'];?>
                        </p>
                        <p class="h4">
                            <span class="fw-bold">
                                Correo Electrónico:
