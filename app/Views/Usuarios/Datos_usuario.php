...
<section class="container mb-5">
    <div class="col-10 col-xs-12 col-sm-12 mb-5 mt-5">
        <!-- Titulo de la tabla -->
        ...
        <div class="d-flex justify-content-center">
            <a href="<?=base_url('cliente/editar/'. $user["id"])?>" class="btn btn-primary btn-lg col-2" type="button">
                <svg width="24" height="24" fill="currentColor" class="bi bi-arrow-repeat" viewBox="0 0 20 20">
