...
<section class="container mt-5 mb-5">
    <div class="col-10 col-xs-12 col-sm-12  mt-3 mb-5">
            ...
            <table class="table table-bordered rounded lg-4 ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-justify h4"> <?=$compras['us_Name'];?> <?=$compras['us_Apellido'];?></td>
                        <td class="text-center h4"> <?=$compras['us_Email'];?> </td>
                        <td class="text-center h4"> <?=$compras['fecha_Guardado'];?> </td>
                        <td class="text-center h4"> $<?=$compras['totalVenta'];?> </td>
                        <td class="text-center h4">
                            <!-- Centra el botón de borrar en la columna asignada -->
                            <div class="d-flex justify-content-center">
                                <?php if(session()->us_Perfil_id == 2): ?>
                                <a href="<?php echo base_url("cliente/detalles?id_compra=". $compras['id_VentaCabec'])?>" class="btn btn-primary" type="button">
                                ...
                                <?php else:?>
                                <a href="<?php echo base_url("administrador/detalles?id_compra=". $compras['id_VentaCabec'])?>" class="btn btn-primary" type="button">
                                    <svg width="24" height="24" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16">
                                        <path d="M16 8s-3-5.5-8-5.5S0 8 0 8s3 5.5 8 5.5S16 8 16 8zM1.173 8a13.133 13.133 0 0 1 1.66-2.043C4.12 4.668 5.88 3.5 8 3.5c2.12 0 3.879 1.168 5.168 2.457A13.133 13.133 0 0 1 14.828 8c-.058.087-.122.183-.195.288-.335.48-.83 1.12-1.465 1.755C11.879 11.332 10.119 12.5 8 12.5c-2.12 0-3.879-1.168-5.168-2.457A13.134 13.134 0 0 1 1.172 8z"/>
                                        <path d="M8 5.5a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zM4.5 8a3.5 3.5 0 1 1 7 0 3.5 3.5 0 0 1-7 0z"/>
                                    </svg>
        ...
        <?php else: ?>
        <div class="col-lg-12 col-md-12 col-sm-12 col-12 texto mt-5 mb-5">
            <div class="d-flex justify-content-center text-danger">
                <svg width="38" height="38" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
                    <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"/>
                </svg>
            </div>
            <p class="text-center h3 mb-3 me-4 ">
                No se encuentran ventas realizadas
            </p>
        </div>
